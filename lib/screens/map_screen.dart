...
class _MapScreenState extends State<MapScreen> {
  ...
  Widget _buildMapWidget(BuildContext context) {
    ...
    if (platform == TargetPlatform.android ||
      ...
      // Web fallback: OpenStreetMap static image (no API key required)
      const double lat = -1.286389;
      const double lng = 36.817223;
      final osmUrl = 'https://staticmap.openstreetmap.de/staticmap.php?center=$lat,$lng&zoom=12&size=600x220&markers=$lat,$lng,blue-pushpin';
      return Column(
        children: [
          Image.network(
            osmUrl,
